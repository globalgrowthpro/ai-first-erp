...
export const dict: Dict = {
  ...
  hr_attendance: { ar: "الحضور والانصراف", en: "Attendance & Shifts" },
  hr_leaves: { ar: "الإجازات والمغادرات", en: "Leaves & Time Off" },
  hr_payroll: { ar: "الرواتب ومسير الأجور", en: "Payroll & Payslips" },
  hr_ai: { ar: "ذكاء الموارد البشرية", en: "HR AI Insights" },
  hr_activeStaff: { ar: "إجمالي الموظفين", en: "Active Employees" },
  hr_presentToday: { ar: "حضور اليوم", en: "Present Today" },
  hr_pendingLeaves: { ar: "طلبات إجازة معلقة", en: "Pending Leaves" },
  hr_monthlyPayroll: { ar: "إجمالي مسير الرواتب", en: "Monthly Payroll" },
